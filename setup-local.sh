...
echo "  1. Remote mode (recommended for Python Workers):"
echo "     npm run dev:remote"
echo ""
echo "  2. Local mode (may require network access for Pyodide):"
echo "     npm run dev"
echo ""
echo "💡 If you encounter DNS errors with local mode, use remote mode instead."
