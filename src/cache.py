"""
Cache management functions for rate limiting, readiness cache, and timeline cache
"""
from js import Date
...
def get_rate_limit_cache():
    """Get rate limit cache data"""
    return _rate_limit_cache


def get_rate_limit_cache_ttl():
    """Get rate limit cache TTL"""
    return _RATE_LIMIT_CACHE_TTL


def get_readiness_rate_limit():
    """Get readiness rate limit value"""
    return _READINESS_RATE_LIMIT


def get_readiness_rate_window():
    """Get readiness rate window value"""
    return _READINESS_RATE_WINDOW


def get_readiness_cache_ttl():
    """Get readiness cache TTL"""
    return _READINESS_CACHE_TTL
